//
//  TEListHeaderFooterController.swift
//  GymateTest
//
...
class TEListHeaderFooterController<T: TEListCell<U>, U, H: UICollectionReusableView, F: UICollectionReusableView>: UICollectionViewController {
    
    /// An array of U objects to render to screen. When using items.append, manual call to reload data will be needed.
    open var items = [U]() {
        didSet {
